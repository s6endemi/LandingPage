...
// Modern, readable fonts for a fresh design
const inter = Inter({
  variable: "--font-inter",
  subsets: ["latin"],
  display: "swap",
    ...
    <html lang="de" className="light">
      ...
      >
        ...
        <div className="fixed inset-0 -z-10 overflow-hidden">
          ...
          {/* Top wave shape */}
          <div className="absolute top-0 left-0 right-0 h-[600px] w-full opacity-[0.04]">
            <svg
        ...
        {/* The entire content area including header and main */}
