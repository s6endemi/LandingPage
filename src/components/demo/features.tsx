...
export const BodyAnalyzerDemo: React.FC = () => {
  ...
  return (
    <div className="relative h-full w-full bg-gray-50 overflow-hidden rounded-xl shadow-md">
      {/* Header ohne Tabs */}
      <div className="absolute top-0 left-0 right-0 bg-[#8B5CF6] text-white py-2.5 px-3 z-10 rounded-t-xl">
        <div className="flex justify-between items-center">
      ...
      <div className="absolute top-[42px] left-0 right-0 bottom-0 p-3.5 overflow-y-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm p-3.5 mb-3.5">
          ...
          {/* Visual Comparison Area - Vereinfacht */}
          <div className="h-32 mb-3 bg-[#8B5CF6]/5 rounded-xl flex">
            <div className="w-1/2 h-full border-r border-white/30 px-3 flex flex-col justify-center items-center">
              <div className="text-xs text-gray-500 mb-2">Vorher</div>
              <div className="h-16 w-10 bg-[#8B5CF6]/20 rounded-full flex items-center justify-center">
            ...
            <div className="w-1/2 h-full px-3 flex flex-col justify-center items-center">
              <div className="text-xs text-gray-500 mb-2">Nachher</div>
              <div className="h-16 w-10 bg-[#8B5CF6]/30 rounded-full flex items-center justify-center">
                <svg className="w-6 h-6 text-[#8B5CF6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        <div className="bg-white rounded-xl shadow-sm p-3.5">
          ...
          <div className="grid grid-cols-3 gap-2.5 mb-3.5">
            {[
              ...
              <div key={index} className="bg-[#8B5CF6]/5 rounded-lg p-2.5 text-center">
                <div className="text-[#8B5CF6] font-medium text-sm mb-1">
                  {stat.value > 0 ? "+" : ""}
                  {stat.value}
                  {stat.unit}
                </div>
          ...
          <button
            className="w-full py-2.5 bg-[#8B5CF6] text-white rounded-lg text-sm font-medium"
          >
...
// Mobile optimierte Versionen
export const MobileAiCoachDemo = AiCoachDemo // Bereits mobil-optimiert
export const MobileAdaptiveTrainingDemo = AdaptiveTrainingDemo // Bereits mobil-optimiert

// Spezielle mobile Version für Nutrition Scanner
export const MobileNutritionSyncDemo: React.FC = () => {
  const [scanComplete, setScanComplete] = useState(false)
  const [scanning, setScanning] = useState(false)
  ...
  return (
    <div className="relative h-full w-full bg-gray-50 overflow-hidden rounded-xl shadow-md">
      ...
      <div className="absolute top-[42px] left-0 right-0 bottom-0 p-3 overflow-y-auto">
        <AnimatePresence mode="wait">
          {scanning && (
            <motion.div
              className="bg-white rounded-xl shadow-sm p-4 mb-3 flex flex-col items-center justify-center"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            >
              ...
              <div className="text-sm font-medium text-gray-700 mb-2">Analysiere...</div>
          ...
          {scanComplete && (
            <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-3">
              <div className="px-3 py-2 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                <div className="flex items-center">
                  <svg className="w-4 h-4 text-[#F59E0B] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      strokeWidth="1.5"
                  ...
                  <div className="font-medium text-xs text-gray-700">Mediterrane Bowl</div>
                </div>
                <div className="text-xs text-[#F59E0B] font-medium">Heute</div>
              </div>
              ...
              <div className="p-3">
                <div className="grid grid-cols-2 gap-2 mb-3">
                  {[
                    ...
                    <div key={index} className="bg-gray-50 rounded-lg p-2 text-center">
                      <div className="text-gray-700 font-medium text-xs mb-0.5">{stat.value}</div>
                      <div className="text-[10px] text-gray-500">{stat.label}</div>
                    </div>
                  ))}
                </div>

                <div className="bg-[#F59E0B]/5 rounded-lg p-2 mb-3">
                  <div className="flex items-start">
                    <div className="w-6 h-6 rounded-full bg-[#F59E0B] flex items-center justify-center mr-2 flex-shrink-0">
                      <svg
                    ...
                    <div>
                      <div className="text-xs text-gray-700">
                        <span className="font-medium">Perfekt nach dem Training!</span> 28g Protein für deine Regeneration.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <button
                  className="w-full py-2 bg-[#F59E0B] text-white rounded-lg text-xs font-medium mt-2"
                  onClick={() => setScanComplete(false)}
                >
                  Neue Mahlzeit scannen
                </button>
          ...
          {!scanComplete && !scanning && (
            <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-sm p-3">
              <div className="text-center mb-3">
                <div className="h-10 w-10 mx-auto mb-2 bg-[#F59E0B]/10 rounded-full flex items-center justify-center">
                ...
                <div className="text-xs text-gray-600">
                  Fotografiere deine Mahlzeit für sofortige Analyse und optimierte Empfehlungen
                </div>
              </div>

              <div>
                <button
                  className="w-full py-2 bg-[#F59E0B] text-white rounded-lg text-xs font-medium 
                             animate-pulse"
                  onClick={handleScan}
                >
                  Mahlzeit scannen
                </button>
                <div className="text-center mt-2 text-[10px] text-[#F59E0B] font-medium flex items-center justify-center">
    ...
    <div className="relative h-full w-full bg-gray-50 overflow-hidden rounded-xl shadow-md">
      ...
      <div className="absolute top-[36px] left-0 right-0 bottom-0 p-2.5 overflow-y-auto">
        <div className="bg-white rounded-xl shadow-sm p-2.5 mb-2.5">
          ...
          <button
            className="w-full py-2 bg-[#8B5CF6] text-white rounded-lg text-xs font-medium"
          >
            Neues Foto hinzufügen
          </button>
        </div>
