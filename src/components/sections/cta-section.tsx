...
export function WaitlistCta() {
  ...
  return (
    <section ref={containerRef} className="relative py-16 md:py-24 overflow-hidden bg-gray-50 isolate">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="relative">
            ...
            <div className={`p-6 md:p-10 text-center relative z-10 ${submitted ? "pb-8" : "pb-10"}`}>
              ...
              >
                ...
                in der
                <br className="hidden sm:block" /> Athly-Community
              </motion.h2>
              ...
              >
                Sei einer der Ersten, die Zugang zum revolutionären Athly KI-Coach erhalten. Limitierte Plätze für den
              ...
              <AnimatePresence mode="wait">
                {!submitted ? (
                  ...
                  >
                    ...
                    <motion.form onSubmit={handleSubmit} className="max-w-xl mx-auto mb-6">
                      ...
                      {errorMessage && <p className="mt-2 text-left text-xs text-red-500">{errorMessage}</p>}
                    </motion.form>
                    ...
                    <div className="space-y-6 mb-6">
                      ...
                      >
                        ...
                        >
                          ...
                          <span>
                            Nur noch <b>limitierte</b> Plätze
                          </span>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-500">Über 250 Personen haben sich bereits eingetragen</p>
                      </motion.div>
                    </div>
                  </motion.div>
                ) : (
                  ...
                  >
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full mx-auto flex items-center justify-center mb-6 bg-[#9bc539]/10">
                      <svg
                        className="w-8 h-8 md:w-10 md:h-10 text-[#9bc539]"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2"
                    ...
                    <p className="text-gray-600 max-w-md mx-auto mb-6">
                      Wir haben deine E-Mail-Adresse erhalten und werden dich informieren, sobald dein exklusiver Zugang
                      bereit ist.
                    </p>
          ...
          <div className="py-4 md:py-5 px-6 md:px-8 bg-gray-50 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4 relative">
            ...
            >
              <svg
                className="w-4 h-4 md:w-5 md:h-5 mr-2 text-gray-800"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
              ...
              <span className="text-xs md:text-sm text-gray-500">
                Deine Daten sind sicher & werden nicht weitergegeben
              </span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <p className="text-xs md:text-sm text-gray-500 mb-5 md:mb-6">
            Diese Institutionen vertrauen auf unsere Technologie
          </p>
