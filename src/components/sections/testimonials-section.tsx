...
export function TestimonialSection() {
  ...
  return (
    <section ref={containerRef} className="relative py-16 md:py-20 overflow-hidden bg-white" id="testimonials">
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
            <div className="md:flex">
              ...
              <div className="p-6 md:p-8 md:w-3/5">
                ...
                <div className="relative mb-5 pl-5 border-l-2" style={{ borderLeftColor: colors.primary }}>
