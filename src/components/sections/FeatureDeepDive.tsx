    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          >
            Entdecke, wie unsere innovativen Funktionen deinen Fitness-Alltag revolutionieren und dir zu echten, langfristigen Ergebnissen verhelfen.
          </motion.p>
        </div>
        ...
        <div className="min-h-[70vh] flex flex-col">
          ...
          <div className={`fixed z-50 top-1/2 transform -translate-y-1/2 right-4 hidden md:block transition-opacity duration-500 ${isMouseOver ? 'opacity-100' : 'opacity-0'}`}>
            <div className="space-y-2">
              {featureInsights.map((_, index) => (
                <button
                  ...
                  style={{ 
                    backgroundColor: activeDeepDive === index 
                      ? featureInsights[activeDeepDive].color 
                      : ''
                  }}
                  onClick={() => scrollToCard(index)}
                  ...
                  <div className="flex flex-col md:flex-row h-full">
                    ...
                    <div className="md:w-1/2 p-6 md:p-8 flex flex-col justify-between overflow-y-auto">
                      ...
                      <div className="mb-6 bg-gray-50 rounded-xl p-5 relative">
                        <div 
                          className="absolute -left-2 top-3 text-4xl opacity-20"
                          style={{ color: feature.color }}
                        >
                          "
                        </div>
                        <p className="text-gray-600 italic text-sm mb-2 relative z-10">
                          "{feature.quote.text}"
                        </p>
                        <p 
