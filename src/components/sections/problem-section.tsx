...
export function RefinedProblemSection() {
  ...
  // Überarbeitete Animation Varianten - subtiler und eleganter
  const fadeIn = {
  ...
  return (
    <section className="py-28 overflow-hidden font-sans" id="problem">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        {/* Section Header mit modernem Typografie-Ansatz */}
        <div className="max-w-3xl mx-auto text-center mb-24">
          <motion.div
            className="inline-block font-medium mb-5 text-xs tracking-wider uppercase px-4 py-1.5 rounded-full"
            style={{ 
              color: colors.primary,
          ...
          <motion.h2 
            className="text-3xl sm:text-4xl lg:text-5xl font-semibold mb-8 tracking-tight leading-tight"
            ...
            variants={fadeIn}
          >
            Warum scheitern die meisten <br className="hidden sm:block" />Fitness&shy;programme?
          </motion.h2>
          ...
          >
            Trotz zahlloser Fitness-Apps und Trainingsprogramme bleibt langfristiger Erfolg selten.<br className="hidden md:block" />
            Die Ursachen sind überraschend konstant:
          </motion.p>
        </div>

        {/* Problem Cards - elegantere, subtilere Darstellung */}
        <div className="grid md:grid-cols-3 gap-x-8 gap-y-16 mb-32">
          {painPoints.map((point, index) => (
            <motion.div
              key={index}
              className="flex flex-col h-full rounded-2xl overflow-hidden bg-white"
            ...
            >
              {/* Bild mit subtilerem Farbakzent */}
              <div className="aspect-[5/3] overflow-hidden relative">
                ...
                {/* Modernes Tag-Element über dem Bild */}
                <div
                  className="absolute bottom-5 left-5 py-1 px-3 rounded-full text-xs font-medium backdrop-blur-sm"
                  style={{ 
              ...
              {/* Content mit eleganter Typografie */}
              <div className="p-6 sm:p-8 flex-grow flex flex-col">
                <div className="mb-4 flex items-center">
                  <div 
                    className="flex-shrink-0 p-2 mr-4 rounded-lg"
                    style={{ 
        ...
        {/* Reality-Check-Bereich - eleganter, aufgeräumter */}
        <motion.div
        ...
        >
          ...
          <div className="absolute -z-10 inset-0 bg-white rounded-3xl border border-gray-100/50 transform rotate-0.5 opacity-75"></div>
          
          <div className="rounded-3xl overflow-hidden" style={{ boxShadow: "0 4px 20px rgba(16, 24, 40, 0.04), 0 2px 6px rgba(16, 24, 40, 0.02)" }}>
            <div className="md:grid md:grid-cols-2">
              {/* Linke Spalte - Visuelle Darstellung mit elegantem Text-Overlay */}
              <div className="relative h-full min-h-[320px] md:min-h-full">
                <img 
                ...
                {/* Overlay Content mit subtilerer Typografie */}
                <div className="relative z-10 p-8 md:p-12 h-full flex flex-col justify-center">
                  <h3 
                    className="text-xl sm:text-2xl font-semibold text-white mb-5 tracking-tight"
                  >
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      <a
                        href="#solution"
                        className="inline-flex items-center text-white rounded-xl px-6 py-3 text-sm font-medium transition-all duration-300 border border-white/20 backdrop-blur-sm bg-white/10 hover:bg-white/15"
                      >
                        <span>Die bessere Alternative entdecken</span>
                        <svg className="ml-2 w-4 h-4 transition-transform duration-300 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Rechte Spalte - Moderne Darstellung der Fakten */}
              <div className="p-8 md:p-12 flex flex-col justify-center bg-white">
                <h3 
                  className="text-xl font-semibold mb-10 tracking-tight"
                  style={{ color: colors.dark }}
                >
                  Die Zahlen sprechen für sich
                </h3>
                
                {/* Statistiken - modernere, subtilere Visualisierung */}
                <div className="space-y-10">
                  {[
                    ...
                    >
                      <div
                        className="w-14 h-14 md:w-16 md:h-16 rounded-xl flex items-center justify-center mr-5 flex-shrink-0"
                        style={{ 
                          backgroundColor: `${stat.color}08`,
                          color: stat.color
                        }}
                      >
                        <span className="text-xl md:text-2xl font-medium">{stat.value}</span>
                      </div>
                      
                      <div className="flex-1">
                        <p 
                          className="text-base font-normal mb-2.5"
                          style={{ color: colors.text }}
                        >
                ...
                {/* Subtile Trennung zum nächsten Abschnitt */}
