  ...
  const painPoints = [
    {
      ...
      description:
        "Vorgefertigte Programme ignorieren deinen Körpertyp, deine Trainingshistorie und persönlichen Bedürfnisse – ein Grund, warum sie selten funktionieren.",
      imageUrl:
        "https://images.unsplash.com/photo-1616279969902-60bc89fc751a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    ...
    },
    {
      ...
      description:
        "Ohne persönliche Betreuung fehlt die Verantwortlichkeit. Jede verpasste Session wird leichter zur Gewohnheit – und der innere Schweinehund gewinnt.",
      imageUrl:
        "https://images.unsplash.com/photo-1591311630200-ffa9120a540f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    ...
    },
    {
      ...
      description:
        "Du stößt auf Fragen zur Technik, Ernährung oder Verletzungen? Eine App bietet keine echten Antworten – und Google liefert oft widersprüchliche Informationen.",
      imageUrl:
        "https://images.unsplash.com/photo-1621252179027-65c82c3f1723?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16 lg:mb-24">
          ...
          <motion.h2
            ...
            variants={fadeIn}
          >
            Warum scheitern die meisten <br className="hidden sm:block" />
            ...
            >
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-8 flex-grow flex flex-col">
                <div className="mb-3 md:mb-4 flex items-center">
                  ...
                  <h3 className="font-semibold text-base md:text-lg lg:text-xl" style={{ color: colors.dark }}>
                    {point.title}
                  </h3>
                </div>

                <p className="flex-grow text-sm md:text-base" style={{ color: colors.textLight, lineHeight: "1.6" }}>
                  {point.description}
                </p>

                {/* Subtile visuelle Trennung */}
                <div className="pt-4 md:pt-5 mt-auto">
                  <div className="w-10 md:w-12 h-px" style={{ backgroundColor: `${point.color}25` }}></div>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          ...
          <div
            ...
            style={{ boxShadow: "0 4px 20px rgba(16, 24, 40, 0.04), 0 2px 6px rgba(16, 24, 40, 0.02)" }}
          >
            <div className="flex flex-col md:grid md:grid-cols-2">
              ...
              <div className="relative h-full min-h-[240px] sm:min-h-[280px] md:min-h-full">
                ...
                <div className="relative z-10 p-6 sm:p-8 md:p-12 h-full flex flex-col justify-center">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-3 md:mb-5 tracking-tight">
                  ...
                  >
                    Die überwiegende Mehrheit der Menschen scheitert nicht aus Mangel an Willenskraft – sondern weil
                    ihnen die richtige Form der Unterstützung fehlt.
                  </p>
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      ...
                      >
                        ...
                        <svg
                          className="ml-2 w-3.5 h-3.5 md:w-4 md:h-4 transition-transform duration-300 group-hover:translate-x-0.5"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="text-sm sm:text-base font-normal mb-2 md:mb-2.5" style={{ color: colors.text }}>
