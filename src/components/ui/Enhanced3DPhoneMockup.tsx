      ...
      >
        ...
        >
          ...
          <div className="perspective-[1200px] group">
            {/* Phone Frame with 3D transform - SLIGHTLY LARGER SIZE FOR DESKTOP */}
            <div
              className="relative mx-auto w-[280px] h-[580px] md:w-[320px] md:h-[660px] rounded-[54px] p-2.5 overflow-hidden transform preserve-3d group-hover:rotate-y-3 group-hover:-rotate-x-2 transition-transform duration-700"
              style={{
            ...
            >
              ...
              >
                ...
                {/* Content container */}
                <div className="absolute inset-0 z-20 bg-white">{content}</div>
              </div>
            </div>
            ...
            <div className="absolute top-[99%] left-1/2 -translate-x-1/2 z-0 pointer-events-none">
              <div
                className="w-[210px] h-[25px] opacity-20 blur-xl"
                style={{
              ...
              ></div>
              <div
                className="w-[260px] h-[20px] opacity-10 blur-lg mt-1"
                style={{
