    ...
    <div className="max-w-3xl mx-auto px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="space-y-8 text-gray-600 font-[450]">
        <section className="space-y-4">
          ...
          <h4 className="text-base font-[550] mt-4 mb-2">
          ...
          <p>
            ...
            Daten handeln, die Sie in das Formular für die Warteliste eingeben.
          </p>
          <p>
          ...
          <p>
            Die von Ihnen angegebenen E-Mail-Adressen für die Warteliste verwenden wir, um Sie über den Launch unserer
            Athly-Plattform zu informieren.
          </p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-[550] text-gray-800 tracking-tight-plus">
            2. Allgemeine Hinweise und Pflichtinformationen
          </h2>

          <h3 className="text-lg font-[550] text-gray-800 mt-6 mb-3">Datenschutz</h3>
          <p>
            Der Betreiber dieser Seite nimmt den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre
          ...
          <h3 className="text-lg font-[550] text-gray-800 mt-6 mb-3">
        ...
        <section className="space-y-4">
          ...
          <p>
            Wenn Sie sich auf unserer Warteliste eintragen, wird Ihre E-Mail-Adresse und gegebenenfalls weitere von
            Ihnen angegebene Daten zwecks Information über den Launch unserer Athly-Plattform gespeichert. Diese Daten
            werden auf der Supabase-Plattform gespeichert, einem Cloud-Datenbankdienst mit Servern in der EU.
          </p>
          <p>
            Die Verarbeitung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO (Einwilligung). Sie
            können diese Einwilligung jederzeit widerrufen, indem Sie uns kontaktieren. Die Rechtmäßigkeit der bereits
            erfolgten Datenverarbeitungsvorgänge bleibt vom Widerruf unberührt.
          </p>
          <p>
            Die von Ihnen für die Warteliste eingegebenen Daten verbleiben bei uns, bis Sie uns zur Löschung auffordern,
            Ihre Einwilligung zur Speicherung widerrufen oder der Zweck für die Datenspeicherung entfällt (z.B. nach
            erfolgtem Launch und Information darüber). Zwingende gesetzliche Bestimmungen – insbesondere
        ...
        <section className="space-y-4">
          ...
          <p>
            Unsere Website verwendet Cookies. Cookies sind kleine Textdateien, die auf Ihrem Rechner abgelegt werden und
            die Ihr Browser speichert. Sie dienen dazu, unser Angebot nutzerfreundlicher, effektiver und sicherer zu
            machen.
          </p>
          <p>
            ...
            oder die Speicherdauer abläuft.
          </p>
          <p>
          ...
          <p>
            Soweit Cookies von uns eingesetzt werden, erfolgt dies auf Basis des Art. 6 Abs. 1 lit. f DSGVO. Unser
            Interesse ist die Bereitstellung einer funktionierenden und nutzerfreundlichen Website. Teilweise setzen wir
            Cookies nur ein, wenn Sie uns Ihre Einwilligung dazu gegeben haben (Art. 6 Abs. 1 lit. a DSGVO). Die
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            Austragung aus dem Newsletter bei uns gespeichert und nach der Abbestellung des Newsletters oder nach
