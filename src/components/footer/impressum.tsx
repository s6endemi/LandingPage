    ...
    <div className="max-w-3xl mx-auto px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="space-y-8 text-gray-600 font-[450]">
        <section className="space-y-4">
          ...
          <p className="pt-2">
            <strong className="font-[550]">Hinweis:</strong>
            <br />
            Athly befindet sich derzeit in der Entwicklungsphase. Diese Website dient der Vorstellung des Projekts und
            dem Aufbau einer Interessentenliste.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            <a
              ...
              className="text-[#9bc539] hover:underline"
            >
